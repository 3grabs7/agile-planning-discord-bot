...
{
    public abstract class GitHubIssueCreationStepBase : IGitHubIssueCreationStep
    {
        protected readonly string _content;

        public GitHubIssueCreationStepBase(string content)
        {
            _content = content;
        }

        public Action<DiscordMessage> OnMessageAdded { get; set; } = delegate { };
        public abstract IGitHubIssueCreationStep NextStep { get; }
